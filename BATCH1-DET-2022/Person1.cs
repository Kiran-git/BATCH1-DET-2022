...
namespace BATCH1_DET_2022
{
    public class Person1
    {
        ...
        public Person1(string firstName, string lastName, string email, DateOnly dOB)
        {
        ...
        public Person1(string firstName, string lastName, string email)
        {
            this.FirstName = firstName;
            this.LastName = lastName;
            this.Email = email;
        }
        public Person1(string firstName, string lastName, DateOnly dOB)
        {
            this.FirstName = firstName;
            this.LastName = lastName;
            this.DOB = dOB;
